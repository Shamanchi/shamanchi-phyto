...
// Основной сайт студии Shamanchi (orbit): http://shamanchi.ru/. HTTPS на домене сейчас
// отдаёт SSL-ошибку, поэтому публичная ссылка ведёт на http (проверено HTTP 200).
